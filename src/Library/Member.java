...
public class Member extends javax.swing.JFrame {
    ...
    public void LoadMem(){
        ...
        try {
            ...
            DefaultTableModel d =(DefaultTableModel)TableM.getModel();
            d.setRowCount(0);
    ...
    private void initComponents() {
        ...
        txtMPno = new javax.swing.JTextField();
        txtMAddress = new java.awt.TextArea();
        ...
        txtMPno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtMPnoActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtMPno, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtMAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(25, 25, 25)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtMPno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel4))
                        .addGap(45, 45, 45)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void TableMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMMouseClicked
        ...
        DefaultTableModel d1 =(DefaultTableModel)TableM.getModel();
        int selectIndex = TableM.getSelectedRow();
        int id = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
        txtMName.setText(d1.getValueAt(selectIndex, 1).toString());
        txtMAddress.setText(d1.getValueAt(selectIndex, 2).toString());
        txtMPno.setText(d1.getValueAt(selectIndex, 3).toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String MAddress = txtMAddress.getText();
        String MPno = txtMPno.getText();
        
        try {
            pst = con.prepareCall("update member set Member = ?, Address = ?, PhoneNo = ? where MID = ? ");
            pst.setString(1, MName);
            pst.setString(2, MAddress);
            pst.setString(3, MPno);
            pst.setInt(4, id);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = con.prepareCall("Delete from member where MID=?");
            pst.setInt(1, id);
            int k = pst.executeUpdate();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = con.prepareCall("insert into member(Member,Address,PhoneNo) values(?,?,?)");
            pst.setString(1, MName);
            pst.setString(2, MAddress);
            pst.setString(3, MPno);
            int k = pst.executeUpdate();
    ...
    private void txtMPnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMPnoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMPnoActionPerformed
    ...
    private java.awt.TextArea txtMAddress;
    private javax.swing.JTextField txtMName;
    private javax.swing.JTextField txtMPno;
